...
//const char ssid[] = "aisfibre_2.4G_FF2A3A";  //  your network SSID (name)
//const char pass[] = "7EFF2A3A";       // your network password
const char ssid[] = "comptia";  //  your network SSID (name)
const char pass[] = "comptiatc";       // your network password
